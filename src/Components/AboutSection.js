  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-1  lg:grid-cols-10">
      <div className="md:col-span-1 lg:col-span-3">
        <img src={darkImg} className="w-full"></img>
      </div>
      <article className="p-8 md:col-span-1 lg:p-12 lg:col-span-4">
        <h2 className="font-semibold text-2xl lg:text-3xl uppercase "> About our furniture</h2>
        <p className="text-slate-900 opacity-70 mt-6">
      ...
      <div className="md:col-span-1 lg:col-span-3">
        <img src={lightImg} className="w-full"></img>
      </div>
    </section>
  );
};
